...
@section('content')
  ...
  <section class="content-header">
    <h1>
      {{ $module_name }}
      <a class="btn btn-success btn-sm pull-right" href="{{ route(Request::segment(2) . '.show', ['id'=> $student->id]) }}">
  ...
  <section class="content">
    ...
    @endif
        ...
        <form role="form" action="{{ route(Request::segment(2) . '.store', ['id' => $health->id ?? $student ->id]) }}" method="POST" id="form_product">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="box box-primary">
                        ...
                        <form action="{{ route(Request::segment(2) . '.store', ['id' => $health->id ?? $student ->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="box-body">
                                                ...
                                                <div class="col-md-4">
                                                 ...
                                                 <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="health_rate" value="{{ old('health_rate') }}" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
