                ...
                <table class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->get('Mã nhà cung cấp'); ?></th>
                            <th><?php echo app('translator')->get('Tên nhà cung cấp'); ?></th>
                            ...
                            <tr class="valign-middle">
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning" data-toggle="tooltip" title="<?php echo app('translator')->get('Update'); ?>"
                                       href="<?php echo e(route('suppliers.edit', $row->id)); ?>">
                                        <i class="fa fa-pencil-square-o"></i>
                                    </a>
                
                                    <form action="<?php echo e(route('suppliers.destroy', $row->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\steam\steamwonder\resources\views/admin/pages/meal/suppliers/index.blade.php ENDPATH**/ ?>