...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        ...
        <form role="form" action="<?php echo e(route('admission.student.store')); ?>" method="POST" >
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-lg-12">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\steam\steamwonder\resources\views/admin/pages/admissionstudents/create.blade.php ENDPATH**/ ?>