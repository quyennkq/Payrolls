...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <form action="<?php echo e(route('admission.receipt')); ?>" method="GET" id="form_filter">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-default btn-sm" href="<?php echo e(route('admission.receipt')); ?>">
                                ...
                                <tr class="valign-middle">
                                    ...
                                    <td class="">
                                        ...
                                        <button class="btn btn-sm btn-success btn_show_detail" data-toggle="tooltip"
                                            ...
                                            data-url="<?php echo e(route('receipt.view', $row->id)); ?>" title="<?php echo app('translator')->get('Xem nhanh'); ?>"
                                            data-original-title="<?php echo app('translator')->get('Xem nhanh'); ?>">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                        <?php if($admin_auth->id == $row->admin_created_id && $row->type_receipt == 'new_student'): ?>
                                            <a class="btn btn-sm btn-warning" data-toggle="tooltip"
                                                ...
                                                style="min-width: 34px" href="<?php echo e(route('receipt.show', $row->id)); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\steamwonder\resources\views/admin/pages/admissionstudents/receipt_index.blade.php ENDPATH**/ ?>