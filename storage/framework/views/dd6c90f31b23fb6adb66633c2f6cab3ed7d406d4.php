                                        ...
                                        <div class="d-flex-wap">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="<?php echo e(old('admin_code') ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="json_params[position]"
                                                        ...
                                                        value="<?php echo e(old('json_params[position]') ?? ''); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="json_params[brief]" class="form-control" rows="5"><?php echo e(old('json_params[brief]')); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="json_params[content]" class="form-control" id="content_vi"><?php echo e(old('json_params[content]')); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <select name="parent_id" class=" form-control select2">
                                    ...
                                    <?php $__currentLoopData = $direct_manager; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($val->id); ?>"
                                            <?php echo e(isset($my_info) && $my_info == $val->id ? 'selected' : ''); ?>>
                                            <?php echo e($val->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group box_img_right">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="avatar" class="form-control inp_hidden" type="hidden" name="avatar"
                                        placeholder="<?php echo app('translator')->get('Image source'); ?>" value="">
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\steamwonder\resources\views/admin/pages/admins/create.blade.php ENDPATH**/ ?>