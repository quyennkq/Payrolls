    ...
    <section class="content-header">
        <h1>
            ...
            <a class="btn btn-sm btn-warning pull-right" href="<?php echo e(route(Request::segment(2) . '.create')); ?>"><i
                    class="fa fa-plus"></i> <?php echo app('translator')->get('Thêm mới trương trình ngoại khóa'); ?></a>
        </h1>
    </section>
<?php $__env->stopSection(); ?>
                        ...
                        <table class="table table-hover table-bordered ">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->get('Tên trương trình'); ?></th>
                                ...
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <form action="" method="POST"
                                        ...
                                        <tr class="valign-middle">
                                            ...
                                            <td>
                                                <?php echo e($row->first_date); ?>

                                            </td>
                                            <td>
                                                <?php echo e($row->last_date); ?>
                                            ...
                                            <td>
                                                <?php echo e($row->form_organizational); ?>

                                            </td>
                                            <td>
                                                <?php echo e($row->form_participation); ?>

                                            </td>
                                            <td>
                                                <?php echo e($row->expense); ?>

                                            </td>
                                            <td>
                                                <a class="btn btn-sm btn-primary"
                                                    href="<?php echo e(route('extracurricular.show', ['id' => $row->id])); ?>">
                                                    <i class="fa fa-eye"></i>
                                                </a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\steam\steamwonder\resources\views/admin/pages/extracurricular/index.blade.php ENDPATH**/ ?>